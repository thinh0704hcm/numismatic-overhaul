...
![Tiny Potato in a fork lift, by Superkat32](https://fabricmc.net/assets/forklift.png)
...
26.1 is a very large update with many changes, especially to the rendering engine. We have only listed a few of the major non-rendering changes here. For a more comprehensive list of changes, please see [NeoForged’s porting “primer”](https://docs.neoforged.net/primer/docs/26.1/).
...
This can be overridden with a [block model](https://fabricmc.net/2026/03/14/261.html) or with `MutableQuadView` and Model Loading API.
